...
@section('description'){{ strip_tags(ucfirst(Lang::get('meta.calendar'))) }}@stop

@section('title'){{ strip_tags(ucfirst(Lang::get('meta.title.pack'))) }}@stop

@section('content')

	<input class="page_title" type="hidden" value="{{ strip_tags(ucfirst(Lang::get('meta.title.calendar'))) }}">
